...
export declare namespace languages.typescript {
...
export declare namespace languages.css {
...
export declare namespace languages.json {
    export interface DiagnosticsOptions {
        /**
...
export declare namespace languages.html {
