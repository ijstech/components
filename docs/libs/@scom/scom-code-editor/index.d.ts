...
declare module "@scom/scom-code-editor/editor.api.ts" {
...
declare module "@scom/scom-code-editor/monaco.ts" {
    ...
    export function getModels(): Promise<IMonaco.editor.ITextModel[]>;
...
declare module "@scom/scom-code-editor/diff-editor.ts" {
    ...
    global {
        namespace JSX {
            interface IntrinsicElements {
                ["i-scom-code-diff-editor"]: ScomCodeDiffEditorElement;
            }
        }
    }
    export class ScomCodeDiffEditor extends Control {
        private _editor;
